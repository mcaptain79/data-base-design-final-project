...
create table ordinary_phoneNum(
    ...
    phoneNum char(11),
    primary key (userName,phoneNum),
    foreign key (userName) references ordinary(userName));
...
-- inserting some histories for test
-- history id = 1
insert into history values (1,'2022-3-5',20,'2022-3-25',10,'b5',1);
insert into student_account_history values ('0023251026',1);
update student_account set balance = balance - 10 where nationalCode = '0023251026';
-- histor id = 2
insert into history values (2,'2022-3-5',20,'2022-3-25',15,'b6',1);
insert into student_account_history values ('0023251026',2);
update student_account set balance = balance - 15 where nationalCode = '0023251026';